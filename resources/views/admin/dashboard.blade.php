...
<body>
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            if (!schoolInfoModal.contains(e.target) && e.target !== editSchoolInfoBtn && e.target !==
                viewSchoolSettingsBtn && e.target !== schoolInfoMenu) {
                schoolInfoModal.classList.remove('active');
            }

            if (!addClassModal.contains(e.target) && e.target !== addClassBtn && e.target !== viewClassesBtn && e
                .target !== classesMenu) {
